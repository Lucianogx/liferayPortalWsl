...
export declare function TreeViewItemStack({ actions, children, disabled, expandable, expanderDisabled, labelId, loading, onLoadMore, tabIndex, ...otherProps }: ITreeViewItemStackProps): JSX.Element;
