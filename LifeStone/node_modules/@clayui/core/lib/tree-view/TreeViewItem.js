...
var _excluded = ["actions", "children", "expandable", "isDragging", "overPosition", "overTarget"],
    _excluded2 = ["actions", "children", "disabled", "expandable", "expanderDisabled", "labelId", "loading", "onLoadMore", "tabIndex"];
...
var TreeViewItem = /*#__PURE__*/_react.default.forwardRef(function TreeViewItemInner(_ref, ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(SpacingContext.Provider, {
    ...
    onBlur: function onBlur(event) {
      ...
      if (actions && !((_item$itemRef$current = item.itemRef.current) !== null && _item$itemRef$current !== void 0 && _item$itemRef$current.contains(event.relatedTarget))) {
        setFocus(false);
      }
    },
    ...
    tabIndex: -2
  }, typeof left === 'string' && !right ? /*#__PURE__*/_react.default.createElement(_layout.default.ContentRow, null, /*#__PURE__*/_react.default.createElement(Drag, {
    labelId: labelId,
...
function TreeViewItemStack(_ref3) {
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.default.ContentRow, otherProps, expandable && !loading && /*#__PURE__*/_react.default.createElement(_layout.default.ContentCol, null, /*#__PURE__*/_react.default.createElement(_button.default, {
    ...
    small: true
  })), /*#__PURE__*/_react.default.createElement(Drag, {
    labelId: labelId,
    tabIndex: tabIndex
...
function ItemIndicator(_ref5) {
  ...
  (0, _react.useEffect)(function () {
    if (indicatorRef.current && currentTarget === target.key && target.dropPosition === position) {
  ...
  return /*#__PURE__*/_react.default.createElement(_liveAnnouncer.VisuallyHidden, {
