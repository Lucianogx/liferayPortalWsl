...
var _excluded = ["children", "className", "collapsable", "collapseClassNames", "defaultExpanded", "displayTitle", "displayType", "expanded", "onExpandedChange", "showCollapseIcon", "spritemap"];
...
function ClayPanel(_ref) {
  ...
  var _useInternalState = (0, _shared.useInternalState)({
    ...
    value: expanded
      ...
      internalExpanded = _useInternalState2[0],
      setInternalExpanded = _useInternalState2[1];
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({}, otherProps, {
    ...
    className: (0, _classnames.default)('panel-header panel-header-link', {
