...
export declare function useNavigation<T extends HTMLElement | null>({ activation, active, containerRef, focusableElements, loop, onNavigate, orientation, typeahead, visible, }: Props<T>): {
    accessibilityFocus: (tab: HTMLElement, tabs?: Array<HTMLElement>) => void;
    navigationProps: {
        onKeyDown: (event: React.KeyboardEvent<HTMLElement>) => void;
    };
};
export declare function getFocusableList<T extends HTMLElement | null>(containeRef: React.MutableRefObject<T>, focusableElements?: Array<string>): HTMLElement[];
