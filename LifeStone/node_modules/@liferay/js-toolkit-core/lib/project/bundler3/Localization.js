...
class Localization {
    constructor(project) {
        ...
        let absPath = (0, getFeaturesFilePath_1.getFeaturesFilePath)(this._project, 'create-jar.features.localization', 'features/localization/Language.properties');
        if (absPath !== undefined) {
            ...
            this._languageFileBaseName = new FilePath_1.default(absPath);
    ...
    get localizationFileMap() {
        ...
        if (this._localizationFileMap === undefined) {
            ...
            this._localizationFileMap = fileNames.reduce((map, fileName) => ((map[this._getFileNameLocale(fileName)] = new FilePath_1.default(path_1.default.join(localizationDirPath, fileName))),
                map), {});
        }
