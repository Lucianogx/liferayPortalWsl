...
var $templateAlias5 = Soy.getTemplate('ClayCheckbox.incrementaldom', 'render');

var $templateAlias6 = Soy.getTemplate('ClayDropdownBase.incrementaldom', 'items');

var $templateAlias2 = Soy.getTemplate('ClayDropdownLabel.incrementaldom', 'render');
...
var $templateAlias7 = Soy.getTemplate('ClayRadio.incrementaldom', 'render');
...
function __deltemplate_s878_3e6ffd21(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  /** @type {!goog.soy.data.SanitizedContent|null|string|undefined} */
  var type = soy.asserts.assertType(opt_data.type == null || (goog.isString(opt_data.type) || opt_data.type instanceof goog.soy.data.SanitizedContent), 'type', opt_data.type, '!goog.soy.data.SanitizedContent|null|string|undefined');
  var itemContent__soy899 = function() {
    ...
    var labelContent__soy912 = function() {
      var iconContent__soy914 = function() {
        if (icon && spritemap) {
          var classes__soy919 = '';
          var $tmp = null;
...
classes__soy919 += $tmp;
  ...
  var itemAttributes__soy1004 = function() {
    if (!disabled) {
...
export { ClayDropdownItem, templates };
