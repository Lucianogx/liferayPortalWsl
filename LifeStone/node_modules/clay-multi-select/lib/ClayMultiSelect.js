...
var ClayMultiSelect = function (_ClayComponent) {
   ...
   */
		...
		value: function _defaultAutocompleteItemSelected(event) {
			...
			var item = this._createItemObject((0, _htmlEscape.htmlEscape)(label), (0, _htmlEscape.htmlEscape)(value));
		...
		value: function _defaultInputChange(event) {
			...
			if (char === ',' || words.length > 1) {
				words.forEach(function (word) {
					var added = _this2._addLabelItem(_this2._createItemObject((0, _htmlEscape.htmlEscape)(word)));
			...
			switch (key) {
				...
				case 'Enter':
					...
					if (element.value) {
						...
						this._addLabelItem(this._createItemObject((0, _htmlEscape.htmlEscape)(value)));
					}
					break;
			}
		}
   ...
   */
		...
		value: function _addLabelItem(item) {
			...
			var filteredItem = this.filteredItems.filter(function (filteredItem) {
				return (0, _htmlEscape.htmlEscape)(filteredItem.data.label.toLowerCase()) === label.toLowerCase();
