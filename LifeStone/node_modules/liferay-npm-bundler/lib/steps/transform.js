...
function babelifyPackage(destPkg) {
    ...
    const prjRelPaths = util_1.findFiles(project_1.default.dir.asNative, gl.prefix(path_1.default.posix.join(project_1.default.dir.asPosix, destPkg.dir.asPosix, '/'), globs));
